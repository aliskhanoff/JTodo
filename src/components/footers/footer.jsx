...
export const Footer = React.memo(({  }) => {
  return (
    ...
    <footer className="p-4 bg-white rounded-lg shadow md:px-6 md:py-8 dark:bg-gray-800">
      ...
      <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" target="_blank" className="hover:underline">Flowbite™</a>. All Rights Reserved.</span>
    </footer>
  </div>
  )
}, (prev, next) => prev === next)
